...
function Footer() {
  return (
    <section className="bg-gray-900 py-10 rounded-2xl ">
    <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 md:mb-0">
                <h3 className="text-white text-lg font-semibold mb-4">Legals</h3>
                <ul>
        ...
        <p className="text-center text-gray-400 mt-8">&copy; 2024. Made with love by Prakhar</p>
    </div>
</section>
...
export default Footer
  ...
  // <section className="relative overflow-hidden py-10 bg-gray-400 border border-t-2 border-t-black w-full mt-auto">
